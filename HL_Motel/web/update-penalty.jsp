            ...
            <div class="main">
                <div class="container" style="margin-top: 2em">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <c:forEach items="${rooms}" var="r">
                                <c:if test="${r.roomID eq penalty.roomID.roomID}">
                                    <option value="${r.roomID}" selected>${r.roomNumber}</option>
                                </c:if>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="date" class="form-control" id="date" name="date" value="${penalty.penDate}" required>
                    </div>
                    <div class="mb-3 mt-3">
                        ...
                        <select class="form-select" name="ruleId">
                            <c:forEach items="${rules}" var="r">
                                <c:if test="${r.ruleID eq penalty.ruleID.ruleID}">
                                    <option value="${r.ruleID}" selected>${r.ruleName}</option>
                                </c:if>
