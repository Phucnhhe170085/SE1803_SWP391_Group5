                ...
                <main>
                    <div class="container">
                        ...
                        <form action="pen" method="post">
                            ...
                            <br>
                            <div class="form-group">
                                <input type="checkbox" id="penStatus" name="penStatus" class="form-check-input" value="true" ${param.penStatus ? 'checked' : ''}>
                                <label for="penStatus" class="form-check-label">Status</label>
                            </div>
                             <br>   
