    ...
    <body>        
        <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
            ...
            <% UserDAO daoUser = new UserDAO();
               ...
               String getImageUser = "abc";
               
               String email = (String) session.getAttribute("email");
               String password = (String) session.getAttribute("password");
               int userID = daoUser.getUserIDByEmailAndPassword(email, password);
               if (userID != 0) {
                   getImageUser = daoUser.getImageUserByUserID(userID);
                }
            %>
            <li>
                <a href="rentercontroller?service=renterprofile">
                    <img src="data:image/jpg;base64,<%= getImageUser %>" alt="No image" width="30px" height="30px" style="border-radius: 10px;">
                </a>
            </li>
        </ul>
