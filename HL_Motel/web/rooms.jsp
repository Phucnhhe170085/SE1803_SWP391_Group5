<%@page import="dao.RoomDAO, models.Room, java.util.Vector"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>

<%
    Vector<Room> listRoom = (Vector<Room>) request.getAttribute("Rooms");
%>
<!doctype html>
<html lang="en">
    <head>
                            ...
                            <div class="property-slider-wrap">
                                ...
                                <div class="property-item">
                                    ...
                                    <div class="property-content">
                                        <div class="price mb-2"><span>1</span></div>
                                        <div>
                                            <span class="d-block mb-2 text-black-50">Thon 3, Tan Xa, Thach That</span>
                                            <span class="city d-block mb-3">Thach That, Ha Noi</span>
