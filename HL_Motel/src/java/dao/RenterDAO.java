...
public class RenterDAO extends MyDAO {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    userDetail = new UserDetail(userID, userName, userGender, userBirth, userAddress, userPhone, userAvatar, userMail, userPassword);
                }
            }
        } catch (SQLException e) {
            System.out.println("Fail: " + e.getMessage());
    ...
    public static void main(String[] args) {
        ...
        UserDetail user = dao.RenterBasicDetail("maingoctu@gmail.com", "pass1234");
